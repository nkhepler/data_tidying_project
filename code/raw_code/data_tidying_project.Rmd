...
### Loading packages for use in data wrangling
...
### Save Raw Data
This allows us to access data even if removed from Web.
...
This data set is in the wide format with a lot of extra, useless data
...
df_department <- df1 %>% 
  ...
  separate(Period, into = c('month','year'), sep = '-', extra='drop', remove=FALSE) %>%
